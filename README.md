...
- The class that defines the protocol can be thought of as __**delegating the work defined by the methods in the protocol to the class that implements them**__.
